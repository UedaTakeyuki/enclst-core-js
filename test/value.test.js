...
//      console.log("item", item)
      ...
      expect(item.value.positionalValues[0]).toEqual('a')
...
//      console.log("item", item)
      ...
      expect(item.value.hasPositinalParams()).toEqual(true)
      expect(item.value.hasNamedParams()).toEqual(false)
      expect(item.value.positionalValues[0]).toEqual('http://uedasoft.com')
      expect(item.value.positionalValues.length).toEqual(1)
      expect(item.title).toEqual("")
    })
...
//      console.log("item", item)
      ...
      expect(item.value.hasPositinalParams()).toEqual(true)
      expect(item.value.hasNamedParams()).toEqual(false)
      expect(item.value.positionalValues[0]).toEqual('https://uedasoft.com')
      expect(item.value.positionalValues.length).toEqual(1)
      expect(item.title).toEqual("")
    })
...
//      console.log("item", item)
      ...
      expect(item.value.hasPositinalParams()).toEqual(true)
      expect(item.value.hasNamedParams()).toEqual(false)
      expect(item.value.positionalValues[0]).toEqual('file://uedasoft')
      expect(item.value.positionalValues.length).toEqual(1)
      expect(item.title).toEqual("")
    })
...
//      console.log("item", item)
      ...
      expect(item.value.hasPositinalParams()).toEqual(true)
      expect(item.value.hasNamedParams()).toEqual(false)
      expect(item.value.positionalValues[0]).toEqual('/abc')
      expect(item.value.positionalValues.length).toEqual(1)
      expect(item.title).toEqual("")
    })
...
//      console.log("item", item)
      ...
      expect(item.value.hasPositinalParams()).toEqual(true)
      expect(item.value.hasNamedParams()).toEqual(false)
      expect(item.value.positionalValues[0]).toEqual('abc/deb')
      expect(item.value.positionalValues.length).toEqual(1)
      expect(item.title).toEqual("")
    })
  });
